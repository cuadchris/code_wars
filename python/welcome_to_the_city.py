...
an array consisting of one or more values that should be joined together with one space between each, and
...
say_hello = lambda a, b, c: f"Hello, {' '.join(a)}! Welcome to {b}, {c}!"

...
# In order to correctly convert a color to grayscale, one has to use luminance Y for Red, 
# Green and Blue components. One can calculate luminance Y through the formula introduced 

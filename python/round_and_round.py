...
# Ram lives in a house which is round in shape. The house has n entrances numbered from 1 to n. For each 
# i in range [1..n - 1] entrances i and i + 1 are adjacent. So are entrances 1 and n.

# Ram's flat is located at entrance a. Each evening he goes for a walk around the house, counting the 
# entrances he walks by. Today Ram decided to walk until he counts b entrances.

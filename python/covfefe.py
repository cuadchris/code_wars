...
For the languages where the string is mutable (such as ruby), don't modify the given string, 
otherwise this will break the test cases.
'''

def covfefe(s):
    return f'{s} covfefe' if 'coverage' not in s else s.replace('coverage', 'covfefe')

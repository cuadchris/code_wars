...
# to define a function xor(a, b) where a and b are the two
# expressions to be evaluated. Your xor function should have the behaviour described above, returning 

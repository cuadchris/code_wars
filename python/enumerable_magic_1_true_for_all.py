...
it should return false. If the sequence is empty, it should return true, since technically nothing failed
the test.
...
_all = lambda seq, fun: not any(not fun(x) for x in seq)
